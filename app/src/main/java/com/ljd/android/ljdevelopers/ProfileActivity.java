...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String userName = intent.getStringExtra(LjdevelopersAdapter.KEY_NAME);
        String image = intent.getStringExtra(LjdevelopersAdapter.KEY_IMAGE);
        final String profileUrl = intent.getStringExtra(LjdevelopersAdapter.KEY_URL);
